...
def get_args():
    ...
    data_group.add_argument('-maxseq', type=int, default=2048,
            help="Maximum depth of subsampled MSA [2048]")
    data_group.add_argument('-maxtoken', type=int, default=2**18,
            help="Maximum depth of subsampled MSA [2**18]")
    data_group.add_argument('-maxlat', type=int, default=256,
            help="Maximum depth of subsampled MSA [256]")
    data_group.add_argument("-lmin", type=int, default=200,
            help="Lower limit of crop size [200]")
    ...
    str_group.add_argument('-l0_out_features', type=int, default=32,
            help="Number of type 0 output features [32]")
    ...
    loss_param = {}
    for param in ['w_dist', 'w_str', 'w_aa', 'w_lddt', 'w_blen', 'w_bang']:
