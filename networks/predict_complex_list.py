...
#    current = datetime.now() - begin_time
#    rr = str(random.randrange(2000))
#    rp = open('/projects/omics/ianh/pathogen_adds/path_ppi/stage10/RFlight_time/pred_time_' + fname + '.time', 'w')
#    rp.write(str(current) + '\n')
#    rp.close()
